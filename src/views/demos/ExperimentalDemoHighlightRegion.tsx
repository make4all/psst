...
export class ExperimentalDemoHighlightRegion <
    ExperimentalDemoHighlightRegionProps, ExperimentalDemoHighlightRegionState> extends React.Component<ExperimentalDemoHighlightRegionProps, ExperimentalDemoHighlightRegionState>
...
protected    sonifierInstance: Sonifier
    ...
    public initializeSource() {
        ...
        this.source.addTemplate(new FilterRangeTemplate(new NoiseSonify(), [this.min, this.max]))
        return this.source
    }
}
