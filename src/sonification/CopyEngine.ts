...
/**
 * OutputEngine class
 * Has a single instances
 * Users of our library get an instance of this to control it i.e. get sink, play, etc.
 */
export class CopyEngine extends BehaviorSubject<OutputStateChange> {
    public spy = create()
    ...
    /**
     * A map of Data sinks handled by the Copy Engine.
     */
    private sinks: Map<
        number,
        {
